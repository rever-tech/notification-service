package notification-service.controller.thrift
...
import notification-service.service.TUserCacheService.{AddUser, GetUser}
import notification-service.service.TUserCacheService.AddUser.{Args, Result}
import notification-service.service.TUserCacheService.GetUser.{Args, Result}
import notification-service.service.{TUserCacheService, UserCacheService}
import notification-service.domain.ThriftImplicit.{T2UserId, T2UserInfo, UserInfo2T, UserId2T,Future2T}
